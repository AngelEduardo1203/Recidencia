...
<head>
    ...
    <style>
        .calendar td {
            ...
            vertical-align: top;
            padding: 5px;
            border: 1px solid rgb(192, 212, 233); /* Corregido */
        }
        .calendar th {
...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <a href="<?= base_url("calendario/formulario") ?>" class="btn btn-success">Añadir Evento</a>
        <a href="<?= base_url("usuario/") ?>" class="btn btn-secondary">Ver Calendario</a>
    </div>
                            ...
                            if ($week === 0 && $dow < $firstWday) {
                               ...
                               if (isset($eventsByDay[$dateStr])) {
                                    foreach ($eventsByDay[$dateStr] as $ev) {
                                        ...
                                        $id = esc($ev['id']);
                                        $url = base_url("calendario/evento/{$id}");
